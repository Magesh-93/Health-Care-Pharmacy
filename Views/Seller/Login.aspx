<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Health_Care_Pharmacy.Views.Seller.Login" %>
            ...
            <div class="col-md-4 bg-white">
                ...
                <form runat="server">
                    ...
                    <asp:Label ID="ErrMsg" class="text-danger" runat="server"></asp:Label>
                        ...
                        <asp:Button id="Login_Txt" type="submit" class="btn btn-primary btn-block" runat="server" Text="Login" OnClick="Login_Txt_Click" />
                    </div>
                </form>
            </div>
            <div class="col-md-4"></div>
